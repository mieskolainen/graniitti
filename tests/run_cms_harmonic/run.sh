...
# Lorentz frames
for FRAME in AH CS HX CM PG GJ
do
...
-d "MC, MC" \
-z "true, true" \
-t "#Omega{Detector}: |#eta| < 2.5 #wedge p_{T} > 0.15 GeV,#Omega{Fiducial}: |#eta| < 2.5 #wedge p_{T} > 0.15 GeV,#Omega{Flat}: |Y_{x}| < 2.5" \
-c $FIDCUTS \
