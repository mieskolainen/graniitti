...
# Generate events
./bin/gr -i ./tests/LHC_TEVATRON_RHIC/CMS11_mumu.json -n 100000 -w true -l false -o "CMS11_mumu" -f "hepmc3"
...
rivet ./output/CMS11_mumu.hepmc3 --analysis=CMS_2011_I954992
rivet-mkhtml --mc-errs Rivet.yoda:"GRANIITTI" -o ./rivetplots/CMS_2011_I954992/
