...
# Generate
./bin/gr -i ./input/test.json -p "PP[CON]<C> -> pi+ pi-"     -o continuum1    -f hepmc3 -n 15100 -r 222
./bin/gr -i ./input/test.json -p "PP[CON]<C> -> pi+ pi-"     -o continuum2    -f hepmc3 -n 14900 -r 333
./bin/gr -i ./input/test.json -p "PP[RES+CON]<C> -> pi+ pi-" -o fullspectrum1 -f hepmc3 -n 15000 -r 555
./bin/gr -i ./input/test.json -p "PP[RES+CON]<C> -> pi+ pi-" -o fullspectrum2 -f hepmc3 -n 15500 -r 777
fi
