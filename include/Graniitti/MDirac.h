...
public:
  ...
  // Helicity spinors
  std::vector<std::complex<double>> XiSpinor(const M4Vec &p,
                                             int helicity) const;
  std::vector<std::complex<double>> uHelChiral(const M4Vec &p,
                                               int helicity) const;
  std::vector<std::complex<double>> vHelChiral(const M4Vec &p,
                                               int helicity) const;

  std::vector<std::complex<double>> uHelDirac(const M4Vec &p,
                                              int helicity) const;
  std::vector<std::complex<double>> vHelDirac(const M4Vec &p,
                                              int helicity) const;

  // Dirac adjoint
  std::vector<std::complex<double>>
  Bar(const std::vector<std::complex<double>> &spinor) const;
  ...
  MMatrix<std::complex<double>> S_basis = {
      std::vector<std::complex<double>>{1.0 / std::sqrt(2.0), 0.0,
