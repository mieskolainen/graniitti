...
namespace kinematics {
  ...
  // p1z + p2z + pz = 0
  // p1E + p2E + pE = s^(1/2)
  //          p1E^2 = m1^2 + p1z^2 + pt1^2
  //          p2E^2 = m2^2 + p2z^2 + pt2^2,
  //
  // There are two quadratic solutions (+- momentum) obtained via direct
  // substitution.
  // The solution here is the "right branch" for the high energy kinematics,
