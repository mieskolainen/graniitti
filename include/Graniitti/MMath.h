...
namespace math {
	...
	inline std::vector<double> Simpson38Weight(unsigned int N) {
		if(N % 3 != 0) { // Must be multiple of 3
			std::string str = "FATAL ERROR: gra::math::SimpsonWeight N = " + std::to_string(N) +
	...
	inline double BESSJ0(double X) {
		...
		************************************************************************/
		double P1 = 1.0, P2 = -0.1098628627E-2, P3 = 0.2734510407E-4, P4 = -0.2073370639E-5,
			   ...
			   Q3 = -0.6911147651E-5, Q4 = 0.7621095161E-6, Q5 = -0.9349451520E-7,
			   R1 = 57568490574.0, R2 = -13362590354.0, R3 = 651619640.7, R4 = -11214424.18,
			   R5 = 77392.33017, R6 = -184.9052456, S1 = 57568490411.0, S2 = 1029532985.0,
	...
	inline double LegendrePl(unsigned int l, double x) {
		if(l == 0) {
			...
			return (429 * x * x * x * x * x * x * x - 693 * x * x * x * x * x + 315 * x * x * x -
					35 * x) /
				   16;
		} else if(l == 8) {
