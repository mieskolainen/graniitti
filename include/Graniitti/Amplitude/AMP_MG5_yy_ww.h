...
#ifndef MG5_Sigma_sm_aa_wpwm_H
#define MG5_Sigma_sm_aa_wpwm_H
...
class AMP_MG5_yy_ww {
 public:
  // Constructor.
  AMP_MG5_yy_ww() { initProc(gra::aux::GetBasePath(2) + "/MG5cards/param_card_yy_ww.dat"); }
  ...
  string name() const { return "a a > w+ w- (sm)"; }
