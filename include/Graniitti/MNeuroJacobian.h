...
MProcess* procptr;
double (MProcess::* ptfptr) (const std::vector<double>& randvec, AuxIntData& aux) = &MProcess::EventWeight;
...
public:
	...
	// [REFERENCE: Dillon et al, Tensorflow Bijector API, https://arxiv.org/abs/1711.10604v1]
	// 
