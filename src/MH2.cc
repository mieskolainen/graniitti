...
// Constructor
MH2::MH2(int xbins, double xmin, double xmax,
...
void MH2::ResetBounds(int xbins, double xmin, double xmax,
...
void MH2::Print() const {
	...
	printf(" [F = %lld | X: U/O = %lld/%lld, Y: U/O = %lld/%lld] \n",
		fills, underflow[0], overflow[0], underflow[1], overflow[1]);
