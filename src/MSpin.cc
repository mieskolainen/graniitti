...
namespace spin {
	...
	void InitTMatrix(gra::HELMatrix& hc, const gra::MParticle& p, const gra::MParticle& p1,
			...
			for(int l = 0; l <= static_cast<int>(J + s); ++l) {
				for(int i = 0; i < static_cast<int>(2 * s1 + 1); ++i) {
					for(int j = 0; j < static_cast<int>(2 * s2 + 1); ++j) {
						...
						const double cg2 = gra::spin::ClebschGordan(s1, s2, lambda1, -lambda2,
																	static_cast<double>(s), lambda);
		...
		const std::string str0 =
			...
			gra::aux::ParityToString(P1) + " " + gra::aux::Spin2XtoString(2 * s2) + "^" +
			gra::aux::ParityToString(P2) + "]" + " (identical = " +
	...
	double W3j(double j1, double j2, double j3, double m1, double m2, double m3) {
		...
		for(int k = lower; k <= upper; ++k) {
			fsum +=
				std::pow(-1.0, k) / (gra::math::factorial(k) * gra::math::factorial(c1 + k) *
	...
	bool Positivity(const MMatrix<std::complex<double>>& rho, unsigned int J) {
		...
		// Dimensions
		if((n - 1) / 2 != J) {
			std::string str = "gra::spin::Positivity: Density matrix does not have a valid "
							  "dimension (2J+1) !";
			throw std::invalid_argument(str);
			return false;
		}
		...
		// Spin-2
			...
			const double pc1 = -6 * a * a - 8 * a * b + 4 * a - 6 * b * b + 4 * b - 4 * c * c -
							   4 * d * d - 4 * e * e - 4 * f * f - 4 * g * g - 4 * h * h -
							   4 * j * j - 4 * k * k - 2 * l * l - 2 * m * m;
			const double pc2 =
				-12 * a * a * a - 48 * a * a * b + 6 * a * a - 48 * a * b * b + 24 * a * b +
				12 * a * c * c - 12 * a * d * d + 12 * a * e * e + 12 * a * f * f - 12 * a * g * g +
				12 * a * h * h - 24 * a * j * j - 24 * a * k * k + 12 * a * m * m - 12 * b * b * b +
				6 * b * b + 12 * b * c * c - 24 * b * d * d + 12 * b * e * e + 12 * b * f * f -
				24 * b * g * g + 12 * b * h * h - 12 * b * j * j - 12 * b * k * k + 12 * b * l * l -
				12 * c * c + 24 * c * d * j + 24 * c * e * l - 24 * c * e * m - 24 * c * g * k +
				12 * d * d * m - 24 * d * e * j + 24 * d * f * k - 24 * d * h * k - 12 * e * e +
				24 * e * g * k - 12 * f * f + 24 * f * g * j + 24 * f * h * l - 24 * f * h * m +
				12 * g * g * m - 24 * g * h * j - 12 * h * h - 12 * j * j * l - 12 * k * k * l -
				6 * l * l - 6 * m * m;
			const double pc3 =
				...
				96 * a * b * j * j - 96 * a * b * k * k + 96 * a * b * l * l + 96 * a * b * m * m -
				48 * a * c * c + 96 * a * c * d * j - 96 * a * c * e * l + 192 * a * c * e * m -
				96 * a * c * g * k - 96 * a * d * e * j + 96 * a * d * f * k - 96 * a * d * h * k -
				48 * a * e * e + 96 * a * e * g * k - 48 * a * f * f + 96 * a * f * g * j -
				96 * a * f * h * l + 192 * a * f * h * m - 96 * a * g * h * j - 48 * a * h * h -
				96 * a * j * j * l - 96 * a * k * k * l - 48 * a * l * l + 96 * b * b * c * c -
				48 * b * b * d * d + 96 * b * b * e * e + 96 * b * b * f * f - 48 * b * b * g * g +
				96 * b * b * h * h + 72 * b * b * m * m - 48 * b * c * c + 96 * b * c * d * j -
				192 * b * c * e * l + 96 * b * c * e * m - 96 * b * c * g * k + 96 * b * d * d * m -
				96 * b * d * e * j + 96 * b * d * f * k - 96 * b * d * h * k - 48 * b * e * e +
				96 * b * e * g * k - 48 * b * f * f + 96 * b * f * g * j - 192 * b * f * h * l +
				96 * b * f * h * m + 96 * b * g * g * m - 96 * b * g * h * j - 48 * b * h * h -
				48 * b * m * m + 24 * c * c * c * c + 48 * c * c * d * d - 48 * c * c * e * e +
				48 * c * c * f * f + 48 * c * c * g * g + 48 * c * c * h * h + 48 * c * c * j * j +
				48 * c * c * k * k + 48 * c * c * l * m + 96 * c * d * d * e + 96 * c * d * j * l -
				96 * c * d * j * m - 192 * c * e * f * h + 96 * c * e * g * g + 96 * c * e * j * j +
				96 * c * e * k * k + 96 * c * e * l - 96 * c * e * m - 96 * c * g * k * l +
				96 * c * g * k * m + 48 * d * d * e * e + 48 * d * d * f * f + 96 * d * d * f * h +
				48 * d * d * h * h + 48 * d * d * l * l - 96 * d * e * j * l + 96 * d * e * j * m +
				96 * d * f * k * l - 96 * d * f * k * m - 96 * d * h * k * l + 96 * d * h * k * m +
				24 * e * e * e * e + 48 * e * e * f * f + 48 * e * e * g * g + 48 * e * e * h * h +
				48 * e * e * j * j + 48 * e * e * k * k + 48 * e * e * l * m + 96 * e * g * k * l -
				96 * e * g * k * m + 24 * f * f * f * f + 48 * f * f * g * g - 48 * f * f * h * h +
				48 * f * f * j * j + 48 * f * f * k * k + 48 * f * f * l * m + 96 * f * g * g * h +
				96 * f * g * j * l - 96 * f * g * j * m + 96 * f * h * j * j + 96 * f * h * k * k +
				96 * f * h * l - 96 * f * h * m + 48 * g * g * h * h + 48 * g * g * l * l -
				96 * g * h * j * l + 96 * g * h * j * m + 24 * h * h * h * h + 48 * h * h * j * j +
				48 * h * h * k * k + 48 * h * h * l * m + 48 * j * j * m * m + 48 * k * k * m * m +
				24 * l * l * m * m;
			const double pc4 =
				120 * (c * c + 2 * c * e + e * e + f * f + 2 * f * h + h * h - a * b - a * l +
					   b * m + l * m) *
				(a * l - 2 * c * e - a * b - 2 * f * h - b * m + l * m + 2 * a * b * b +
				 2 * a * a * b - 2 * a * c * c - 2 * b * c * c - 2 * a * e * e + 2 * b * d * d -
				 2 * a * f * f - 2 * b * e * e - 2 * b * f * f - 2 * a * h * h + 2 * b * g * g -
				 2 * b * h * h + 2 * a * j * j + 2 * a * k * k - 2 * a * a * l + 2 * b * b * m -
				 2 * d * d * l - 2 * g * g * l + 2 * j * j * m + 2 * k * k * m + c * c + e * e +
				 f * f + h * h + 4 * a * c * e + 4 * b * c * e - 2 * a * b * l + 4 * a * f * h +
				 2 * a * b * m + 4 * b * f * h - 4 * c * d * j + 4 * d * e * j + 4 * c * g * k -
				 4 * d * f * k + 4 * d * h * k - 4 * e * g * k - 4 * f * g * j + 4 * g * h * j -
				 2 * a * l * m - 2 * b * l * m);
			...
			std::string str = "gra::spin::Positivity: Not a valid spin (only J = 1 and 2 "
							  "accepted) !";
			gra::matoper::PrintMatrixSeparate(rho);
			throw std::invalid_argument(str);
			return false;
