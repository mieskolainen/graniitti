			...
			for (int i = 0; i < static_cast<int>(2 * s1 + 1); ++i) {
				for (int j = 0; j < static_cast<int>(2 * s2 + 1); ++j) {
					const double lambda1 =
					    -s1 +
					    static_cast<double>(i); // From negative to positive
					const double lambda2 =
					    -s2 +
					    static_cast<double>(j); // From negative to positive
					...
					const double cg1 = gra::spin::ClebschGordan(
					    static_cast<double>(l), static_cast<double>(s), 0.0,
					    lambda, J, lambda);

					// <s \lambda | s1s2\lambda1,-\lambda2>
					const double cg2 = gra::spin::ClebschGordan(
					    s1, s2, lambda1, -lambda2, static_cast<double>(s),
					    lambda);
...
std::complex<double> SpinAmp(const gra::LORENTZSCALAR &lts, gra::PARAM_RES &resonance) {
	...
	if (lts.decaytree.size() == 2) {
		...
		gra::kinematics::LorentzBoost(lts.pfinal[0], lts.pfinal[0].M(), boosted_daughter,
		                              -1);
...
bool Positivity(const MMatrix<std::complex<double>> &rho, unsigned int J) {
	...
	// Spin-2
		...
		const double pc2 =
		    ...
		    12 * a * m * m - 12 * b * b * b + 6 * b * b + 12 * b * c * c - 24 * b * d * d +
		    12 * b * e * e + 12 * b * f * f - 24 * b * g * g + 12 * b * h * h -
		    12 * b * j * j - 12 * b * k * k + 12 * b * l * l - 12 * c * c + 24 * c * d * j +
		    24 * c * e * l - 24 * c * e * m - 24 * c * g * k + 12 * d * d * m -
		    24 * d * e * j + 24 * d * f * k - 24 * d * h * k - 12 * e * e + 24 * e * g * k -
		    12 * f * f + 24 * f * g * j + 24 * f * h * l - 24 * f * h * m + 12 * g * g * m -
		    24 * g * h * j - 12 * h * h - 12 * j * j * l - 12 * k * k * l - 6 * l * l -
		    6 * m * m;
		const double pc3 =
		    48 * a * a * b - 168 * a * a * b * b - 96 * a * a * a * b + 96 * a * a * c * c +
		    96 * a * a * e * e + 96 * a * a * f * f + 96 * a * a * h * h -
		    48 * a * a * j * j - 48 * a * a * k * k + 72 * a * a * l * l -
		    96 * a * b * b * b + 48 * a * b * b + 144 * a * b * c * c - 96 * a * b * d * d +
		    144 * a * b * e * e + 144 * a * b * f * f - 96 * a * b * g * g +
		    144 * a * b * h * h - 96 * a * b * j * j - 96 * a * b * k * k +
		    96 * a * b * l * l + 96 * a * b * m * m - 48 * a * c * c + 96 * a * c * d * j -
		    96 * a * c * e * l + 192 * a * c * e * m - 96 * a * c * g * k -
		    96 * a * d * e * j + 96 * a * d * f * k - 96 * a * d * h * k - 48 * a * e * e +
		    96 * a * e * g * k - 48 * a * f * f + 96 * a * f * g * j - 96 * a * f * h * l +
		    192 * a * f * h * m - 96 * a * g * h * j - 48 * a * h * h - 96 * a * j * j * l -
		    96 * a * k * k * l - 48 * a * l * l + 96 * b * b * c * c - 48 * b * b * d * d +
		    96 * b * b * e * e + 96 * b * b * f * f - 48 * b * b * g * g +
		    96 * b * b * h * h + 72 * b * b * m * m - 48 * b * c * c + 96 * b * c * d * j -
		    192 * b * c * e * l + 96 * b * c * e * m - 96 * b * c * g * k +
		    96 * b * d * d * m - 96 * b * d * e * j + 96 * b * d * f * k -
		    96 * b * d * h * k - 48 * b * e * e + 96 * b * e * g * k - 48 * b * f * f +
		    96 * b * f * g * j - 192 * b * f * h * l + 96 * b * f * h * m +
		    96 * b * g * g * m - 96 * b * g * h * j - 48 * b * h * h - 48 * b * m * m +
		    24 * c * c * c * c + 48 * c * c * d * d - 48 * c * c * e * e +
		    48 * c * c * f * f + 48 * c * c * g * g + 48 * c * c * h * h +
		    48 * c * c * j * j + 48 * c * c * k * k + 48 * c * c * l * m +
		    96 * c * d * d * e + 96 * c * d * j * l - 96 * c * d * j * m -
		    192 * c * e * f * h + 96 * c * e * g * g + 96 * c * e * j * j +
		    96 * c * e * k * k + 96 * c * e * l - 96 * c * e * m - 96 * c * g * k * l +
		    96 * c * g * k * m + 48 * d * d * e * e + 48 * d * d * f * f +
		    96 * d * d * f * h + 48 * d * d * h * h + 48 * d * d * l * l -
		    96 * d * e * j * l + 96 * d * e * j * m + 96 * d * f * k * l -
		    96 * d * f * k * m - 96 * d * h * k * l + 96 * d * h * k * m +
		    24 * e * e * e * e + 48 * e * e * f * f + 48 * e * e * g * g +
		    48 * e * e * h * h + 48 * e * e * j * j + 48 * e * e * k * k +
		    48 * e * e * l * m + 96 * e * g * k * l - 96 * e * g * k * m +
		    24 * f * f * f * f + 48 * f * f * g * g - 48 * f * f * h * h +
		    48 * f * f * j * j + 48 * f * f * k * k + 48 * f * f * l * m +
		    96 * f * g * g * h + 96 * f * g * j * l - 96 * f * g * j * m +
