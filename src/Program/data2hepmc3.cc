...
int main(int argc, char *argv[]) {
	...
	struct HepMC3::GenRunInfo::ToolInfo generator = {
			std::string("data2hepmc3"),
			std::to_string(gra::aux::GetVersion()).substr(0,5),
			std::string("data")};
    ...
    while (true) {
		...
		ret = fscanf(fp, "%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf",
				     &P1_gen[0], &P1_gen[1], &P1_gen[2], &dummy,
				     &P2_gen[0], &P2_gen[1], &P2_gen[2], &dummy, &PID_weight);
		...
		*/
		...
		// Create 4-vectors
		gra::M4Vec pf1; pf1.SetPxPyPzM(P1_gen[0],P1_gen[1],P1_gen[2], m1);
		gra::M4Vec pf2; pf2.SetPxPyPzM(P2_gen[0],P2_gen[1],P2_gen[2], m2);
		...
		HepMC3::GenParticlePtr gen_beam1 = std::make_shared<HepMC3::GenParticle>(gra::aux::M4Vec2HepMC3(beam1), PDG::PDG_p, PDG::PDG_BEAM);
		HepMC3::GenParticlePtr gen_beam2 = std::make_shared<HepMC3::GenParticle>(gra::aux::M4Vec2HepMC3(beam2), PDG::PDG_p, PDG::PDG_BEAM);

		HepMC3::GenParticlePtr gen_system = std::make_shared<HepMC3::GenParticle>(gra::aux::M4Vec2HepMC3(system), PDG::PDG_system, PDG::PDG_INTERMEDIATE);
		HepMC3::GenParticlePtr gen_p1f    = std::make_shared<HepMC3::GenParticle>(gra::aux::M4Vec2HepMC3(pf1),    PDG::PDG_pip, PDG::PDG_STABLE);
		HepMC3::GenParticlePtr gen_p2f    = std::make_shared<HepMC3::GenParticle>(gra::aux::M4Vec2HepMC3(pf2),    PDG::PDG_pim, PDG::PDG_STABLE);
