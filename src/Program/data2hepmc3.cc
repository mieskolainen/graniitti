...
int main(int argc, char *argv[]) {
  ...
  struct HepMC3::GenRunInfo::ToolInfo generator = {
      ...
      std::to_string(gra::aux::GetVersion()).substr(0, 5), std::string("data")};
  ...
  while (true) {
    ...
    ret = fscanf(fp, "%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf", &P1_gen[0],
                 &P1_gen[1], &P1_gen[2], &dummy, &P2_gen[0], &P2_gen[1],
                 &P2_gen[2], &dummy, &PID_weight);
