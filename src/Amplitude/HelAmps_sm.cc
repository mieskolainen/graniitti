    ...
    std::complex<double> V3[])
{
  ...
  denom = COUP/((P3[0] * P3[0]) - (P3[1] * P3[1]) - (P3[2] * P3[2]) - (P3[3] *
      P3[3]) - M3 * (M3 - cI * W3));
  V3[2] = denom * (OM3 * P3[0] * (-2. * cI * (TMP3 * TMP18) + cI * (TMP8 *
      TMP15 + TMP11 * TMP16)) + (-cI * (V2[2] * TMP15 + V1[2] * TMP16) + 2. *
      cI * (TMP3 * V4[2])));
  V3[3] = denom * (OM3 * P3[1] * (-2. * cI * (TMP3 * TMP18) + cI * (TMP8 *
      TMP15 + TMP11 * TMP16)) + (-cI * (V2[3] * TMP15 + V1[3] * TMP16) + 2. *
      cI * (TMP3 * V4[3])));
  V3[4] = denom * (OM3 * P3[2] * (-2. * cI * (TMP3 * TMP18) + cI * (TMP8 *
      TMP15 + TMP11 * TMP16)) + (-cI * (V2[4] * TMP15 + V1[4] * TMP16) + 2. *
      cI * (TMP3 * V4[4])));
  V3[5] = denom * (OM3 * P3[3] * (-2. * cI * (TMP3 * TMP18) + cI * (TMP8 *
      TMP15 + TMP11 * TMP16)) + (-cI * (V2[5] * TMP15 + V1[5] * TMP16) + 2. *
      cI * (TMP3 * V4[5])));
}
    ...
    COUP, std::complex<double> & vertex)
{
  ...
  TMP3 = (V2[2] * V1[2] - V2[3] * V1[3] - V2[4] * V1[4] - V2[5] * V1[5]); 
  vertex = COUP * 1./2. * (-2. * cI * (TMP9 * TMP15) + cI * (TMP7 * TMP16 +
      TMP3 * TMP17));
}
    ...
    std::complex<double> COUP, double M2, double W2, std::complex<double> V2[])
{
  ...
  denom = COUP/((P2[0] * P2[0]) - (P2[1] * P2[1]) - (P2[2] * P2[2]) - (P2[3] *
      P2[3]) - M2 * (M2 - cI * W2));
  V2[2] = denom * (OM2 * P2[0] * (TMP7 * (-cI * (TMP12) + cI * (TMP13)) + (-cI
      * (TMP5 * TMP11) + cI * (TMP4 * TMP10))) + (TMP7 * (-cI * (P3[0]) + cI *
      (P1[0])) + (V1[2] * (-cI * (TMP4) + cI * (TMP5)) + V3[2] * (-cI * (TMP10)
      + cI * (TMP11)))));
  V2[3] = denom * (OM2 * P2[1] * (TMP7 * (-cI * (TMP12) + cI * (TMP13)) + (-cI
      * (TMP5 * TMP11) + cI * (TMP4 * TMP10))) + (TMP7 * (-cI * (P3[1]) + cI *
      (P1[1])) + (V1[3] * (-cI * (TMP4) + cI * (TMP5)) + V3[3] * (-cI * (TMP10)
      + cI * (TMP11)))));
  V2[4] = denom * (OM2 * P2[2] * (TMP7 * (-cI * (TMP12) + cI * (TMP13)) + (-cI
      * (TMP5 * TMP11) + cI * (TMP4 * TMP10))) + (TMP7 * (-cI * (P3[2]) + cI *
      (P1[2])) + (V1[4] * (-cI * (TMP4) + cI * (TMP5)) + V3[4] * (-cI * (TMP10)
      + cI * (TMP11)))));
  V2[5] = denom * (OM2 * P2[3] * (TMP7 * (-cI * (TMP12) + cI * (TMP13)) + (-cI
      * (TMP5 * TMP11) + cI * (TMP4 * TMP10))) + (TMP7 * (-cI * (P3[3]) + cI *
      (P1[3])) + (V1[5] * (-cI * (TMP4) + cI * (TMP5)) + V3[5] * (-cI * (TMP10)
      + cI * (TMP11)))));
}
    ...
    std::complex<double> COUP, double M3, double W3, std::complex<double> V3[])
{
  ...
  denom = COUP/((P3[0] * P3[0]) - (P3[1] * P3[1]) - (P3[2] * P3[2]) - (P3[3] *
      P3[3]) - M3 * (M3 - cI * W3));
  V3[2] = denom * (OM3 * P3[0] * (TMP3 * (-cI * (TMP13) + cI * (TMP14)) + (-cI
      * (TMP6 * TMP11) + cI * (TMP8 * TMP10))) + (TMP3 * (-cI * (P1[0]) + cI *
      (P2[0])) + (V1[2] * (-cI * (TMP8) + cI * (TMP6)) + V2[2] * (-cI * (TMP10)
      + cI * (TMP11)))));
  V3[3] = denom * (OM3 * P3[1] * (TMP3 * (-cI * (TMP13) + cI * (TMP14)) + (-cI
      * (TMP6 * TMP11) + cI * (TMP8 * TMP10))) + (TMP3 * (-cI * (P1[1]) + cI *
      (P2[1])) + (V1[3] * (-cI * (TMP8) + cI * (TMP6)) + V2[3] * (-cI * (TMP10)
      + cI * (TMP11)))));
  V3[4] = denom * (OM3 * P3[2] * (TMP3 * (-cI * (TMP13) + cI * (TMP14)) + (-cI
      * (TMP6 * TMP11) + cI * (TMP8 * TMP10))) + (TMP3 * (-cI * (P1[2]) + cI *
      (P2[2])) + (V1[4] * (-cI * (TMP8) + cI * (TMP6)) + V2[4] * (-cI * (TMP10)
      + cI * (TMP11)))));
  V3[5] = denom * (OM3 * P3[3] * (TMP3 * (-cI * (TMP13) + cI * (TMP14)) + (-cI
      * (TMP6 * TMP11) + cI * (TMP8 * TMP10))) + (TMP3 * (-cI * (P1[3]) + cI *
      (P2[3])) + (V1[5] * (-cI * (TMP8) + cI * (TMP6)) + V2[5] * (-cI * (TMP10)
      + cI * (TMP11)))));
}
    ...
    std::complex<double> V1[])
{
  ...
  denom = COUP/((P1[0] * P1[0]) - (P1[1] * P1[1]) - (P1[2] * P1[2]) - (P1[3] *
      P1[3]) - M1 * (M1 - cI * W1));
  V1[2] = denom * (-1.) * (-2. * cI * (V2[2] * TMP17) + cI * (TMP9 * V4[2] +
      V3[2] * TMP16));
  V1[3] = denom * (-1.) * (-2. * cI * (V2[3] * TMP17) + cI * (TMP9 * V4[3] +
      V3[3] * TMP16));
  V1[4] = denom * (-1.) * (-2. * cI * (V2[4] * TMP17) + cI * (TMP9 * V4[4] +
      V3[4] * TMP16));
  V1[5] = denom * (-1.) * (-2. * cI * (V2[5] * TMP17) + cI * (TMP9 * V4[5] +
      V3[5] * TMP16));
}
    ...
    std::complex<double> COUP, double M3, double W3, std::complex<double> V3[])
{
  ...
  denom = COUP/((P3[0] * P3[0]) - (P3[1] * P3[1]) - (P3[2] * P3[2]) - (P3[3] *
      P3[3]) - M3 * (M3 - cI * W3));
  V3[2] = denom * (-4. * cI) * (OM3 * - 1./4. * P3[0] * (TMP2 + 4. * (TMP24)) +
      (+1./4. * (F1[2] * F2[4] + F1[3] * F2[5]) + F1[4] * F2[2] + F1[5] *
      F2[3]));
  V3[3] = denom * (-4. * cI) * (OM3 * - 1./4. * P3[1] * (TMP2 + 4. * (TMP24)) +
      (-1./4. * (F1[2] * F2[5] + F1[3] * F2[4]) + F1[4] * F2[3] + F1[5] *
      F2[2]));
  V3[4] = denom * 4. * cI * (OM3 * 1./4. * P3[2] * (TMP2 + 4. * (TMP24)) +
      (+1./4. * cI * (F1[2] * F2[5]) - 1./4. * cI * (F1[3] * F2[4]) - cI *
      (F1[4] * F2[3]) + cI * (F1[5] * F2[2])));
  V3[5] = denom * 4. * cI * (OM3 * 1./4. * P3[3] * (TMP2 + 4. * (TMP24)) +
    ...
    std::complex<double> V4[])
{
  ...
  denom = COUP/((P4[0] * P4[0]) - (P4[1] * P4[1]) - (P4[2] * P4[2]) - (P4[3] *
      P4[3]) - M4 * (M4 - cI * W4));
  V4[2] = denom * (OM4 * P4[0] * (-2. * cI * (TMP3 * TMP21) + cI * (TMP9 *
      TMP19 + TMP7 * TMP20)) + (-cI * (V1[2] * TMP9 + V2[2] * TMP7) + 2. * cI *
      (V3[2] * TMP3)));
  V4[3] = denom * (OM4 * P4[1] * (-2. * cI * (TMP3 * TMP21) + cI * (TMP9 *
      TMP19 + TMP7 * TMP20)) + (-cI * (V1[3] * TMP9 + V2[3] * TMP7) + 2. * cI *
      (V3[3] * TMP3)));
  V4[4] = denom * (OM4 * P4[2] * (-2. * cI * (TMP3 * TMP21) + cI * (TMP9 *
      TMP19 + TMP7 * TMP20)) + (-cI * (V1[4] * TMP9 + V2[4] * TMP7) + 2. * cI *
      (V3[4] * TMP3)));
  V4[5] = denom * (OM4 * P4[3] * (-2. * cI * (TMP3 * TMP21) + cI * (TMP9 *
      TMP19 + TMP7 * TMP20)) + (-cI * (V1[5] * TMP9 + V2[5] * TMP7) + 2. * cI *
      (V3[5] * TMP3)));
}
    ...
    COUP, std::complex<double> & vertex)
{
  ...
  TMP17 = (V3[2] * V4[2] - V3[3] * V4[3] - V3[4] * V4[4] - V3[5] * V4[5]); 
  TMP3 = (V2[2] * V1[2] - V2[3] * V1[3] - V2[4] * V1[4] - V2[5] * V1[5]); 
  vertex = COUP * (-1.) * (-2. * cI * (TMP3 * TMP17) + cI * (TMP9 * TMP15 +
      TMP7 * TMP16));
}
    ...
    std::complex<double> COUP, double M1, double W1, std::complex<double> V1[])
{
  ...
  V1[2] = denom * (TMP9 * (-cI * (P2[0]) + cI * (P3[0])) + (V2[2] * (-cI *
      (TMP4) + cI * (TMP5)) + V3[2] * (-cI * (TMP8) + cI * (TMP6))));
  V1[3] = denom * (TMP9 * (-cI * (P2[1]) + cI * (P3[1])) + (V2[3] * (-cI *
      (TMP4) + cI * (TMP5)) + V3[3] * (-cI * (TMP8) + cI * (TMP6))));
  V1[4] = denom * (TMP9 * (-cI * (P2[2]) + cI * (P3[2])) + (V2[4] * (-cI *
      (TMP4) + cI * (TMP5)) + V3[4] * (-cI * (TMP8) + cI * (TMP6))));
  V1[5] = denom * (TMP9 * (-cI * (P2[3]) + cI * (P3[3])) + (V2[5] * (-cI *
      (TMP4) + cI * (TMP5)) + V3[5] * (-cI * (TMP8) + cI * (TMP6))));
}
    ...
    std::complex<double> V4[])
{
  ...
  denom = COUP/((P4[0] * P4[0]) - (P4[1] * P4[1]) - (P4[2] * P4[2]) - (P4[3] *
      P4[3]) - M4 * (M4 - cI * W4));
  V4[2] = denom * 1./2. * (OM4 * - P4[0] * (-2. * cI * (TMP9 * TMP19) + cI *
      (TMP7 * TMP20 + TMP3 * TMP21)) + (-2. * cI * (V1[2] * TMP9) + cI * (V2[2]
      * TMP7 + V3[2] * TMP3)));
  V4[3] = denom * 1./2. * (OM4 * - P4[1] * (-2. * cI * (TMP9 * TMP19) + cI *
      (TMP7 * TMP20 + TMP3 * TMP21)) + (-2. * cI * (V1[3] * TMP9) + cI * (V2[3]
      * TMP7 + V3[3] * TMP3)));
  V4[4] = denom * 1./2. * (OM4 * - P4[2] * (-2. * cI * (TMP9 * TMP19) + cI *
      (TMP7 * TMP20 + TMP3 * TMP21)) + (-2. * cI * (V1[4] * TMP9) + cI * (V2[4]
      * TMP7 + V3[4] * TMP3)));
  V4[5] = denom * 1./2. * (OM4 * - P4[3] * (-2. * cI * (TMP9 * TMP19) + cI *
      (TMP7 * TMP20 + TMP3 * TMP21)) + (-2. * cI * (V1[5] * TMP9) + cI * (V2[5]
      * TMP7 + V3[5] * TMP3)));
}
