...
void VVVV1_0(std::complex<double> V1[], std::complex<double> V2[],
	...
	TMP1 = (V3[2] * V1[2] - V3[3] * V1[3] - V3[4] * V1[4] - V3[5] * V1[5]);
	TMP11 =
	    (V4[2] * V1[2] - V4[3] * V1[3] - V4[4] * V1[4] - V4[5] * V1[5]);
	TMP9 = (V2[2] * V3[2] - V2[3] * V3[3] - V2[4] * V3[4] - V2[5] * V3[5]);
	TMP0 = (V4[2] * V2[2] - V4[3] * V2[3] - V4[4] * V2[4] - V4[5] * V2[5]);
...
void VVV1P0_1(std::complex<double> V2[], std::complex<double> V3[],
	...
	V1[2] = denom * (TMP9 * (-cI * (P2[0]) + cI * (P3[0])) +
	                 (V2[2] * (-cI * (TMP4) + cI * (TMP5)) +
	                  V3[2] * (-cI * (TMP7) + cI * (TMP6))));
	V1[3] = denom * (TMP9 * (-cI * (P2[1]) + cI * (P3[1])) +
	                 (V2[3] * (-cI * (TMP4) + cI * (TMP5)) +
	                  V3[3] * (-cI * (TMP7) + cI * (TMP6))));
	V1[4] = denom * (TMP9 * (-cI * (P2[2]) + cI * (P3[2])) +
	                 (V2[4] * (-cI * (TMP4) + cI * (TMP5)) +
	                  V3[4] * (-cI * (TMP7) + cI * (TMP6))));
	V1[5] = denom * (TMP9 * (-cI * (P2[3]) + cI * (P3[3])) +
	                 (V2[5] * (-cI * (TMP4) + cI * (TMP5)) +
	                  V3[5] * (-cI * (TMP7) + cI * (TMP6))));
}
