...
void VVV1P0_1(std::complex<double> V2[], std::complex<double> V3[],
  ...
  V1[2] = denom * (TMP5 * (-cI * (P2[0]) + cI * (P3[0])) +
                   (V2[2] * (-cI * (TMP1) + cI * (TMP2)) +
                    V3[2] * (-cI * (TMP4) + cI * (TMP3))));
  V1[3] = denom * (TMP5 * (-cI * (P2[1]) + cI * (P3[1])) +
                   (V2[3] * (-cI * (TMP1) + cI * (TMP2)) +
                    V3[3] * (-cI * (TMP4) + cI * (TMP3))));
  V1[4] = denom * (TMP5 * (-cI * (P2[2]) + cI * (P3[2])) +
                   (V2[4] * (-cI * (TMP1) + cI * (TMP2)) +
                    V3[4] * (-cI * (TMP4) + cI * (TMP3))));
  V1[5] = denom * (TMP5 * (-cI * (P2[3]) + cI * (P3[3])) +
                   (V2[5] * (-cI * (TMP1) + cI * (TMP2)) +
                    V3[5] * (-cI * (TMP4) + cI * (TMP3))));
}
