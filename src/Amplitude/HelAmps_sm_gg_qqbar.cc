	...
	F2[2] =
		denom * cI * (F1[2] * (P2[0] * (V3[2] + V3[5]) +
					  ...
					  (F1[3] * (P2[0] * (V3[3] - cI * (V3[4])) +
								(P2[1] * (V3[5] - V3[2]) + (P2[2] * (-cI * (V3[5]) + cI * (V3[2])) +
															P2[3] * (+cI * (V3[4]) - V3[3])))) +
	...
	F1[4] = denom * (-cI) *
			(F2[4] * (P1[0] * (V3[2] + V3[5]) +
			 ...
			 (F2[5] * (P1[0] * (V3[3] + cI * (V3[4])) +
					   (P1[1] * (V3[5] - V3[2]) + (P1[2] * (-cI * (V3[2]) + cI * (V3[5])) -
												   P1[3] * (V3[3] + cI * (V3[4]))))) +
			  M1 * (F2[2] * (V3[5] - V3[2]) + F2[3] * (V3[3] + cI * (V3[4])))));
	F1[5] =
		denom * cI * (F2[4] * (P1[0] * (+cI * (V3[4]) - V3[3]) +
							   (P1[1] * (V3[2] + V3[5]) + (P1[2] * (-1.) * (+cI * (V3[2] + V3[5])) +
														   P1[3] * (+cI * (V3[4]) - V3[3])))) +
					  (F2[5] * (P1[0] * (V3[5] - V3[2]) +
								(P1[1] * (V3[3] + cI * (V3[4])) +
								 (P1[2] * (V3[4] - cI * (V3[3])) + P1[3] * (V3[5] - V3[2])))) +
...
void VVV1P0_1(std::complex<double> V2[], std::complex<double> V3[], std::complex<double> COUP,
	...
	denom = COUP / ((P1[0] * P1[0]) - (P1[1] * P1[1]) - (P1[2] * P1[2]) - (P1[3] * P1[3]) -
					M1 * (M1 - cI * W1));
	V1[2] = denom * (TMP5 * (-cI * (P2[0]) + cI * (P3[0])) +
					 (V2[2] * (-cI * (TMP1) + cI * (TMP2)) + V3[2] * (-cI * (TMP4) + cI * (TMP3))));
	V1[3] = denom * (TMP5 * (-cI * (P2[1]) + cI * (P3[1])) +
					 (V2[3] * (-cI * (TMP1) + cI * (TMP2)) + V3[3] * (-cI * (TMP4) + cI * (TMP3))));
	V1[4] = denom * (TMP5 * (-cI * (P2[2]) + cI * (P3[2])) +
					 (V2[4] * (-cI * (TMP1) + cI * (TMP2)) + V3[4] * (-cI * (TMP4) + cI * (TMP3))));
	V1[5] = denom * (TMP5 * (-cI * (P2[3]) + cI * (P3[3])) +
