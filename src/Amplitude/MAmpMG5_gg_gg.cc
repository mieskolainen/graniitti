...
void MAmpMG5_gg_gg::calculate_wavefunctions(const int perm[],
                                            const int hel[]) {
	...
	MG5_sm_gg_gg::VVV1P0_1(w[0], w[1], pars->GC_10, pars->ZERO, pars->ZERO,
	                       w[4]);
	MG5_sm_gg_gg::VVV1P0_1(w[0], w[2], pars->GC_10, pars->ZERO, pars->ZERO,
	                       w[5]);
	MG5_sm_gg_gg::VVV1P0_1(w[0], w[3], pars->GC_10, pars->ZERO, pars->ZERO,
	                       w[6]);
