...
// Get amplitude
std::complex<double> MAmpMG5_gg_qqbar::CalcAmp(gra::LORENTZSCALAR &lts,
                                               double alpS) {
...
void MAmpMG5_gg_qqbar::calculate_wavefunctions(const int perm[],
                                               const int hel[]) {
  ...
  MG5_sm_gg_qqbar::VVV1P0_1(w[0], w[1], pars->GC_10, pars->ZERO, pars->ZERO,
                            w[4]);
  MG5_sm_gg_qqbar::FFV1_1(w[2], w[0], pars->GC_11, pars->ZERO, pars->ZERO,
                          w[5]);
  MG5_sm_gg_qqbar::FFV1_2(w[3], w[0], pars->GC_11, pars->ZERO, pars->ZERO,
                          w[6]);
