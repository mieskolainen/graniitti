...
// Get amplitude
std::complex<double> MAmpMG5_gg_ggg::CalcAmp(gra::LORENTZSCALAR &lts,
                                             double alpS) {
...
void MAmpMG5_gg_ggg::calculate_wavefunctions(const int perm[],
  ...
  MG5_sm_gg_ggg::VVV1P0_1(w[0], w[1], pars->GC_10, pars->ZERO, pars->ZERO,
                          w[5]);
  MG5_sm_gg_ggg::VVV1P0_1(w[2], w[3], pars->GC_10, pars->ZERO, pars->ZERO,
                          w[6]);
  MG5_sm_gg_ggg::VVV1P0_1(w[2], w[4], pars->GC_10, pars->ZERO, pars->ZERO,
                          w[7]);
  MG5_sm_gg_ggg::VVV1P0_1(w[3], w[4], pars->GC_10, pars->ZERO, pars->ZERO,
                          w[8]);
  MG5_sm_gg_ggg::VVV1P0_1(w[0], w[2], pars->GC_10, pars->ZERO, pars->ZERO,
                          w[9]);
  MG5_sm_gg_ggg::VVV1P0_1(w[1], w[3], pars->GC_10, pars->ZERO, pars->ZERO,
                          w[10]);
  MG5_sm_gg_ggg::VVV1P0_1(w[1], w[4], pars->GC_10, pars->ZERO, pars->ZERO,
                          w[11]);
  MG5_sm_gg_ggg::VVV1P0_1(w[0], w[3], pars->GC_10, pars->ZERO, pars->ZERO,
                          w[12]);
  MG5_sm_gg_ggg::VVV1P0_1(w[1], w[2], pars->GC_10, pars->ZERO, pars->ZERO,
                          w[13]);
  MG5_sm_gg_ggg::VVV1P0_1(w[0], w[4], pars->GC_10, pars->ZERO, pars->ZERO,
                          w[14]);
  MG5_sm_gg_ggg::VVVV1P0_1(w[0], w[1], w[2], pars->GC_12, pars->ZERO,
                           pars->ZERO, w[15]);
  MG5_sm_gg_ggg::VVVV3P0_1(w[0], w[1], w[2], pars->GC_12, pars->ZERO,
                           pars->ZERO, w[16]);
  MG5_sm_gg_ggg::VVVV4P0_1(w[0], w[1], w[2], pars->GC_12, pars->ZERO,
                           pars->ZERO, w[17]);
  MG5_sm_gg_ggg::VVVV1P0_1(w[0], w[1], w[3], pars->GC_12, pars->ZERO,
                           pars->ZERO, w[18]);
  MG5_sm_gg_ggg::VVVV3P0_1(w[0], w[1], w[3], pars->GC_12, pars->ZERO,
                           pars->ZERO, w[19]);
  MG5_sm_gg_ggg::VVVV4P0_1(w[0], w[1], w[3], pars->GC_12, pars->ZERO,
                           pars->ZERO, w[20]);
  MG5_sm_gg_ggg::VVVV1P0_1(w[0], w[1], w[4], pars->GC_12, pars->ZERO,
                           pars->ZERO, w[21]);
  MG5_sm_gg_ggg::VVVV3P0_1(w[0], w[1], w[4], pars->GC_12, pars->ZERO,
                           pars->ZERO, w[22]);
  MG5_sm_gg_ggg::VVVV4P0_1(w[0], w[1], w[4], pars->GC_12, pars->ZERO,
                           pars->ZERO, w[23]);
  MG5_sm_gg_ggg::VVVV1P0_1(w[0], w[2], w[3], pars->GC_12, pars->ZERO,
                           pars->ZERO, w[24]);
  MG5_sm_gg_ggg::VVVV3P0_1(w[0], w[2], w[3], pars->GC_12, pars->ZERO,
                           pars->ZERO, w[25]);
  MG5_sm_gg_ggg::VVVV4P0_1(w[0], w[2], w[3], pars->GC_12, pars->ZERO,
                           pars->ZERO, w[26]);
  MG5_sm_gg_ggg::VVVV1P0_1(w[0], w[2], w[4], pars->GC_12, pars->ZERO,
                           pars->ZERO, w[27]);
  MG5_sm_gg_ggg::VVVV3P0_1(w[0], w[2], w[4], pars->GC_12, pars->ZERO,
                           pars->ZERO, w[28]);
  MG5_sm_gg_ggg::VVVV4P0_1(w[0], w[2], w[4], pars->GC_12, pars->ZERO,
                           pars->ZERO, w[29]);
  MG5_sm_gg_ggg::VVVV1P0_1(w[0], w[3], w[4], pars->GC_12, pars->ZERO,
                           pars->ZERO, w[30]);
  MG5_sm_gg_ggg::VVVV3P0_1(w[0], w[3], w[4], pars->GC_12, pars->ZERO,
                           pars->ZERO, w[31]);
  MG5_sm_gg_ggg::VVVV4P0_1(w[0], w[3], w[4], pars->GC_12, pars->ZERO,
                           pars->ZERO, w[32]);
...
double MAmpMG5_gg_ggg::matrix_1_gg_ggg() {
  ...
  jamp[0] = +2. * (+std::complex<double>(0, 1) * amp[0] +
                   ...
                   std::complex<double>(0, 1) * amp[23] +
                   std::complex<double>(0, 1) * amp[24] -
                   std::complex<double>(0, 1) * amp[29] +
                   std::complex<double>(0, 1) * amp[27] +
                   std::complex<double>(0, 1) * amp[35] +
                   std::complex<double>(0, 1) * amp[34] -
                   std::complex<double>(0, 1) * amp[43] -
                   std::complex<double>(0, 1) * amp[42]);
  jamp[1] = +2. * (+std::complex<double>(0, 1) * amp[1] -
                   std::complex<double>(0, 1) * amp[2] +
                   ...
                   std::complex<double>(0, 1) * amp[29] -
                   std::complex<double>(0, 1) * amp[27] +
                   std::complex<double>(0, 1) * amp[32] +
                   std::complex<double>(0, 1) * amp[31] -
                   std::complex<double>(0, 1) * amp[44] +
                   std::complex<double>(0, 1) * amp[42]);
  jamp[2] = +2. * (-std::complex<double>(0, 1) * amp[0] -
                   std::complex<double>(0, 1) * amp[1] -
                   std::complex<double>(0, 1) * amp[4] -
                   std::complex<double>(0, 1) * amp[3] -
                   std::complex<double>(0, 1) * amp[19] +
                   std::complex<double>(0, 1) * amp[20] -
                   std::complex<double>(0, 1) * amp[22] -
                   std::complex<double>(0, 1) * amp[23] +
                   std::complex<double>(0, 1) * amp[25] -
                   std::complex<double>(0, 1) * amp[32] +
                   std::complex<double>(0, 1) * amp[30] -
                   std::complex<double>(0, 1) * amp[35] -
                   std::complex<double>(0, 1) * amp[34] -
                   std::complex<double>(0, 1) * amp[40] -
                   std::complex<double>(0, 1) * amp[39]);
  jamp[3] = +2. * (+std::complex<double>(0, 1) * amp[1] -
                   std::complex<double>(0, 1) * amp[2] +
                   std::complex<double>(0, 1) * amp[4] +
                   std::complex<double>(0, 1) * amp[5] -
                   ...
                   std::complex<double>(0, 1) * amp[11] -
                   std::complex<double>(0, 1) * amp[25] +
                   std::complex<double>(0, 1) * amp[29] +
                   std::complex<double>(0, 1) * amp[28] +
                   std::complex<double>(0, 1) * amp[32] -
                   std::complex<double>(0, 1) * amp[30] -
                   std::complex<double>(0, 1) * amp[41] +
                   std::complex<double>(0, 1) * amp[39]);
  jamp[4] = +2. * (-std::complex<double>(0, 1) * amp[0] -
                   std::complex<double>(0, 1) * amp[1] -
                   std::complex<double>(0, 1) * amp[4] -
                   std::complex<double>(0, 1) * amp[3] -
                   std::complex<double>(0, 1) * amp[13] +
                   std::complex<double>(0, 1) * amp[14] -
                   std::complex<double>(0, 1) * amp[16] -
                   std::complex<double>(0, 1) * amp[17] +
                   std::complex<double>(0, 1) * amp[26] -
                   std::complex<double>(0, 1) * amp[32] -
                   std::complex<double>(0, 1) * amp[31] -
                   std::complex<double>(0, 1) * amp[35] +
                   std::complex<double>(0, 1) * amp[33] -
                   std::complex<double>(0, 1) * amp[37] -
                   std::complex<double>(0, 1) * amp[36]);
  jamp[5] = +2. * (+std::complex<double>(0, 1) * amp[0] +
                   std::complex<double>(0, 1) * amp[2] +
                   std::complex<double>(0, 1) * amp[3] -
                   std::complex<double>(0, 1) * amp[5] -
                   ...
                   std::complex<double>(0, 1) * amp[35] -
                   std::complex<double>(0, 1) * amp[33] -
                   std::complex<double>(0, 1) * amp[38] +
                   std::complex<double>(0, 1) * amp[36]);
  jamp[6] = +2. * (+std::complex<double>(0, 1) * amp[6] +
                   std::complex<double>(0, 1) * amp[8] +
                   std::complex<double>(0, 1) * amp[9] -
                   std::complex<double>(0, 1) * amp[11] +
                   std::complex<double>(0, 1) * amp[18] +
                   ...
                   std::complex<double>(0, 1) * amp[43] +
                   std::complex<double>(0, 1) * amp[42]);
  jamp[7] = +2. * (+std::complex<double>(0, 1) * amp[7] -
                   std::complex<double>(0, 1) * amp[8] +
                   std::complex<double>(0, 1) * amp[10] +
                   std::complex<double>(0, 1) * amp[11] +
                   std::complex<double>(0, 1) * amp[12] +
                   ...
                   std::complex<double>(0, 1) * amp[44] -
                   std::complex<double>(0, 1) * amp[42]);
  jamp[8] = +2. * (-std::complex<double>(0, 1) * amp[6] -
                   std::complex<double>(0, 1) * amp[7] -
                   std::complex<double>(0, 1) * amp[10] -
                   std::complex<double>(0, 1) * amp[9] -
                   std::complex<double>(0, 1) * amp[19] +
                   ...
                   std::complex<double>(0, 1) * amp[41] -
                   std::complex<double>(0, 1) * amp[40]);
  jamp[9] = +2. * (-std::complex<double>(0, 1) * amp[0] -
                   std::complex<double>(0, 1) * amp[2] -
                   std::complex<double>(0, 1) * amp[3] +
                   std::complex<double>(0, 1) * amp[5] +
                   std::complex<double>(0, 1) * amp[7] -
