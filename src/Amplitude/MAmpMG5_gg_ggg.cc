...
std::complex<double> MAmpMG5_gg_ggg::CalcAmp(gra::LORENTZSCALAR& lts, double alpS) {
	...
	double p5[] = {lts.decaytree[2].p4.E(),  lts.decaytree[2].p4.Px(),
	               lts.decaytree[2].p4.Py(), lts.decaytree[2].p4.Pz()};
...
void MAmpMG5_gg_ggg::calculate_wavefunctions(const int perm[],
                                             const int hel[]) {
...
double MAmpMG5_gg_ggg::matrix_1_gg_ggg() {
  ...
  jamp[0] = +2. * (+std::complex<double> (0, 1) * amp[0] + std::complex<double>
      ...
      (0, 1) * amp[21] + std::complex<double> (0, 1) * amp[23] +
      std::complex<double> (0, 1) * amp[24] - std::complex<double> (0, 1) *
      amp[29] + std::complex<double> (0, 1) * amp[27] + std::complex<double>
  ...
  jamp[1] = +2. * (+std::complex<double> (0, 1) * amp[1] - std::complex<double>
      ...
      (0, 1) * amp[15] + std::complex<double> (0, 1) * amp[17] -
      std::complex<double> (0, 1) * amp[24] + std::complex<double> (0, 1) *
      amp[29] - std::complex<double> (0, 1) * amp[27] + std::complex<double>
      (0, 1) * amp[32] + std::complex<double> (0, 1) * amp[31] -
      std::complex<double> (0, 1) * amp[44] + std::complex<double> (0, 1) *
      amp[42]);
  jamp[2] = +2. * (-std::complex<double> (0, 1) * amp[0] - std::complex<double>
      (0, 1) * amp[1] - std::complex<double> (0, 1) * amp[4] -
      std::complex<double> (0, 1) * amp[3] - std::complex<double> (0, 1) *
      amp[19] + std::complex<double> (0, 1) * amp[20] - std::complex<double>
      (0, 1) * amp[22] - std::complex<double> (0, 1) * amp[23] +
  ...
  jamp[3] = +2. * (+std::complex<double> (0, 1) * amp[1] - std::complex<double>
      ...
      1) * amp[9] + std::complex<double> (0, 1) * amp[11] -
      std::complex<double> (0, 1) * amp[25] + std::complex<double> (0, 1) *
      amp[29] + std::complex<double> (0, 1) * amp[28] + std::complex<double>
      (0, 1) * amp[32] - std::complex<double> (0, 1) * amp[30] -
  ...
  jamp[5] = +2. * (+std::complex<double> (0, 1) * amp[0] + std::complex<double>
      (0, 1) * amp[2] + std::complex<double> (0, 1) * amp[3] -
      std::complex<double> (0, 1) * amp[5] - std::complex<double> (0, 1) *
      amp[7] + std::complex<double> (0, 1) * amp[8] - std::complex<double> (0,
      ...
      amp[36]);
  jamp[6] = +2. * (+std::complex<double> (0, 1) * amp[6] + std::complex<double>
      (0, 1) * amp[8] + std::complex<double> (0, 1) * amp[9] -
      std::complex<double> (0, 1) * amp[11] + std::complex<double> (0, 1) *
      amp[18] + std::complex<double> (0, 1) * amp[19] + std::complex<double>
      (0, 1) * amp[22] + std::complex<double> (0, 1) * amp[21] -
      std::complex<double> (0, 1) * amp[24] - std::complex<double> (0, 1) *
      amp[28] - std::complex<double> (0, 1) * amp[27] + std::complex<double>
      (0, 1) * amp[41] + std::complex<double> (0, 1) * amp[40] +
      std::complex<double> (0, 1) * amp[43] + std::complex<double> (0, 1) *
      amp[42]);
  jamp[7] = +2. * (+std::complex<double> (0, 1) * amp[7] - std::complex<double>
      (0, 1) * amp[8] + std::complex<double> (0, 1) * amp[10] +
      std::complex<double> (0, 1) * amp[11] + std::complex<double> (0, 1) *
      amp[12] + std::complex<double> (0, 1) * amp[13] + std::complex<double>
      (0, 1) * amp[16] + std::complex<double> (0, 1) * amp[15] +
      std::complex<double> (0, 1) * amp[24] + std::complex<double> (0, 1) *
      amp[28] + std::complex<double> (0, 1) * amp[27] + std::complex<double>
      (0, 1) * amp[38] + std::complex<double> (0, 1) * amp[37] +
      std::complex<double> (0, 1) * amp[44] - std::complex<double> (0, 1) *
      amp[42]);
  jamp[8] = +2. * (-std::complex<double> (0, 1) * amp[6] - std::complex<double>
      (0, 1) * amp[7] - std::complex<double> (0, 1) * amp[10] -
      std::complex<double> (0, 1) * amp[9] - std::complex<double> (0, 1) *
      amp[19] + std::complex<double> (0, 1) * amp[20] - std::complex<double>
      (0, 1) * amp[22] - std::complex<double> (0, 1) * amp[23] -
      std::complex<double> (0, 1) * amp[26] - std::complex<double> (0, 1) *
      amp[34] - std::complex<double> (0, 1) * amp[33] - std::complex<double>
      (0, 1) * amp[38] + std::complex<double> (0, 1) * amp[36] -
      std::complex<double> (0, 1) * amp[41] - std::complex<double> (0, 1) *
      amp[40]);
  jamp[9] = +2. * (-std::complex<double> (0, 1) * amp[0] - std::complex<double>
      ...
      std::complex<double> (0, 1) * amp[38] - std::complex<double> (0, 1) *
      amp[36]);
  jamp[10] = +2. * (-std::complex<double> (0, 1) * amp[6] -
      std::complex<double> (0, 1) * amp[7] - std::complex<double> (0, 1) *
      amp[10] - std::complex<double> (0, 1) * amp[9] - std::complex<double> (0,
      1) * amp[13] + std::complex<double> (0, 1) * amp[14] -
      std::complex<double> (0, 1) * amp[16] - std::complex<double> (0, 1) *
      amp[17] - std::complex<double> (0, 1) * amp[25] - std::complex<double>
      (0, 1) * amp[31] - std::complex<double> (0, 1) * amp[30] -
      std::complex<double> (0, 1) * amp[38] - std::complex<double> (0, 1) *
      amp[37] - std::complex<double> (0, 1) * amp[41] + std::complex<double>
      (0, 1) * amp[39]);
  jamp[11] = +2. * (-std::complex<double> (0, 1) * amp[1] +
      ...
      1) * amp[6] + std::complex<double> (0, 1) * amp[8] + std::complex<double>
      (0, 1) * amp[9] - std::complex<double> (0, 1) * amp[11] +
      std::complex<double> (0, 1) * amp[25] - std::complex<double> (0, 1) *
      amp[29] - std::complex<double> (0, 1) * amp[28] - std::complex<double>
      (0, 1) * amp[32] + std::complex<double> (0, 1) * amp[30] +
      std::complex<double> (0, 1) * amp[41] - std::complex<double> (0, 1) *
      amp[39]);
  jamp[12] = +2. * (+std::complex<double> (0, 1) * amp[12] +
      std::complex<double> (0, 1) * amp[14] + std::complex<double> (0, 1) *
      amp[15] - std::complex<double> (0, 1) * amp[17] + std::complex<double>
      (0, 1) * amp[18] + std::complex<double> (0, 1) * amp[19] +
      std::complex<double> (0, 1) * amp[22] + std::complex<double> (0, 1) *
      amp[21] - std::complex<double> (0, 1) * amp[25] - std::complex<double>
      (0, 1) * amp[31] - std::complex<double> (0, 1) * amp[30] +
      std::complex<double> (0, 1) * amp[40] + std::complex<double> (0, 1) *
      amp[39] + std::complex<double> (0, 1) * amp[44] + std::complex<double>
      (0, 1) * amp[43]);
  jamp[13] = +2. * (+std::complex<double> (0, 1) * amp[6] +
      std::complex<double> (0, 1) * amp[7] + std::complex<double> (0, 1) *
      amp[10] + std::complex<double> (0, 1) * amp[9] + std::complex<double> (0,
      1) * amp[13] - std::complex<double> (0, 1) * amp[14] +
      std::complex<double> (0, 1) * amp[16] + std::complex<double> (0, 1) *
      ...
      amp[37] + std::complex<double> (0, 1) * amp[41] - std::complex<double>
      (0, 1) * amp[39]);
  jamp[14] = +2. * (-std::complex<double> (0, 1) * amp[12] -
      std::complex<double> (0, 1) * amp[13] - std::complex<double> (0, 1) *
      amp[16] - std::complex<double> (0, 1) * amp[15] - std::complex<double>
      (0, 1) * amp[18] - std::complex<double> (0, 1) * amp[20] -
      std::complex<double> (0, 1) * amp[21] + std::complex<double> (0, 1) *
      amp[23] + std::complex<double> (0, 1) * amp[26] + std::complex<double>
      (0, 1) * amp[34] + std::complex<double> (0, 1) * amp[33] -
      std::complex<double> (0, 1) * amp[37] - std::complex<double> (0, 1) *
      amp[36] - std::complex<double> (0, 1) * amp[44] - std::complex<double>
      (0, 1) * amp[43]);
  jamp[15] = +2. * (+std::complex<double> (0, 1) * amp[0] +
      ...
      1) * amp[13] - std::complex<double> (0, 1) * amp[14] +
      std::complex<double> (0, 1) * amp[16] + std::complex<double> (0, 1) *
      amp[17] - std::complex<double> (0, 1) * amp[26] + std::complex<double>
      (0, 1) * amp[32] + std::complex<double> (0, 1) * amp[31] +
      std::complex<double> (0, 1) * amp[35] - std::complex<double> (0, 1) *
      amp[33] + std::complex<double> (0, 1) * amp[37] + std::complex<double>
      (0, 1) * amp[36]);
  jamp[16] = +2. * (-std::complex<double> (0, 1) * amp[7] +
      std::complex<double> (0, 1) * amp[8] - std::complex<double> (0, 1) *
      amp[10] - std::complex<double> (0, 1) * amp[11] - std::complex<double>
      (0, 1) * amp[12] - std::complex<double> (0, 1) * amp[13] -
      std::complex<double> (0, 1) * amp[16] - std::complex<double> (0, 1) *
      amp[15] - std::complex<double> (0, 1) * amp[24] - std::complex<double>
      (0, 1) * amp[28] - std::complex<double> (0, 1) * amp[27] -
      std::complex<double> (0, 1) * amp[38] - std::complex<double> (0, 1) *
      amp[37] - std::complex<double> (0, 1) * amp[44] + std::complex<double>
      (0, 1) * amp[42]);
  jamp[17] = +2. * (-std::complex<double> (0, 1) * amp[1] +
      ...
      amp[17] + std::complex<double> (0, 1) * amp[24] - std::complex<double>
      (0, 1) * amp[29] + std::complex<double> (0, 1) * amp[27] -
      std::complex<double> (0, 1) * amp[32] - std::complex<double> (0, 1) *
      amp[31] + std::complex<double> (0, 1) * amp[44] - std::complex<double>
      (0, 1) * amp[42]);
  jamp[18] = +2. * (+std::complex<double> (0, 1) * amp[12] +
      std::complex<double> (0, 1) * amp[13] + std::complex<double> (0, 1) *
      amp[16] + std::complex<double> (0, 1) * amp[15] + std::complex<double>
      (0, 1) * amp[18] + std::complex<double> (0, 1) * amp[20] +
      std::complex<double> (0, 1) * amp[21] - std::complex<double> (0, 1) *
      ...
      amp[36] + std::complex<double> (0, 1) * amp[44] + std::complex<double>
      (0, 1) * amp[43]);
  jamp[19] = +2. * (+std::complex<double> (0, 1) * amp[6] +
      std::complex<double> (0, 1) * amp[7] + std::complex<double> (0, 1) *
      amp[10] + std::complex<double> (0, 1) * amp[9] + std::complex<double> (0,
      1) * amp[19] - std::complex<double> (0, 1) * amp[20] +
      std::complex<double> (0, 1) * amp[22] + std::complex<double> (0, 1) *
      amp[23] + std::complex<double> (0, 1) * amp[26] + std::complex<double>
      (0, 1) * amp[34] + std::complex<double> (0, 1) * amp[33] +
      std::complex<double> (0, 1) * amp[38] - std::complex<double> (0, 1) *
      amp[36] + std::complex<double> (0, 1) * amp[41] + std::complex<double>
      (0, 1) * amp[40]);
  jamp[20] = +2. * (-std::complex<double> (0, 1) * amp[12] -
      std::complex<double> (0, 1) * amp[14] - std::complex<double> (0, 1) *
      amp[15] + std::complex<double> (0, 1) * amp[17] - std::complex<double>
      (0, 1) * amp[18] - std::complex<double> (0, 1) * amp[19] -
      std::complex<double> (0, 1) * amp[22] - std::complex<double> (0, 1) *
  ...
  jamp[21] = +2. * (+std::complex<double> (0, 1) * amp[0] +
      ...
      1) * amp[19] - std::complex<double> (0, 1) * amp[20] +
      std::complex<double> (0, 1) * amp[22] + std::complex<double> (0, 1) *
      amp[23] - std::complex<double> (0, 1) * amp[25] + std::complex<double>
      (0, 1) * amp[32] - std::complex<double> (0, 1) * amp[30] +
      std::complex<double> (0, 1) * amp[35] + std::complex<double> (0, 1) *
      amp[34] + std::complex<double> (0, 1) * amp[40] + std::complex<double>
      (0, 1) * amp[39]);
  jamp[22] = +2. * (-std::complex<double> (0, 1) * amp[6] -
      std::complex<double> (0, 1) * amp[8] - std::complex<double> (0, 1) *
      amp[9] + std::complex<double> (0, 1) * amp[11] - std::complex<double> (0,
      1) * amp[18] - std::complex<double> (0, 1) * amp[19] -
      std::complex<double> (0, 1) * amp[22] - std::complex<double> (0, 1) *
      amp[21] + std::complex<double> (0, 1) * amp[24] + std::complex<double>
      (0, 1) * amp[28] + std::complex<double> (0, 1) * amp[27] -
      std::complex<double> (0, 1) * amp[41] - std::complex<double> (0, 1) *
      amp[40] - std::complex<double> (0, 1) * amp[43] - std::complex<double>
      (0, 1) * amp[42]);
  jamp[23] = +2. * (-std::complex<double> (0, 1) * amp[0] -
      std::complex<double> (0, 1) * amp[2] - std::complex<double> (0, 1) *
      amp[3] + std::complex<double> (0, 1) * amp[5] + std::complex<double> (0,
      1) * amp[18] + std::complex<double> (0, 1) * amp[20] +
      std::complex<double> (0, 1) * amp[21] - std::complex<double> (0, 1) *
      amp[23] - std::complex<double> (0, 1) * amp[24] + std::complex<double>
      (0, 1) * amp[29] - std::complex<double> (0, 1) * amp[27] -
      std::complex<double> (0, 1) * amp[35] - std::complex<double> (0, 1) *
      amp[34] + std::complex<double> (0, 1) * amp[43] + std::complex<double>
      (0, 1) * amp[42]);
