...
#ifndef MG5_Sigma_sm_aa_epveemvex_H
#define MG5_Sigma_sm_aa_epveemvex_H
...
class AMP_MG5_yy_ww_evev
{
  public:

    // Constructor.
    AMP_MG5_yy_ww_evev() {initProc(gra::aux::GetBasePath(2) + "/MG5cards/param_card_yy_ww_evev.dat"); }
    ...
    // Info on the subprocess.
     string name() const {return "a a > e+ ve e- ve~ (sm)";}
  ...
  private:
    ...
    double matrix_1_aa_wpwm_wp_epve_wm_emvex(); 
...
#endif  // MG5_Sigma_sm_aa_epveemvex_H
